...
* Conclusion
  ...
  We developed a EDA library start-kit in R to help us investigate
  relationship among variables in a data set. We useed visualization
  techniques and also 2 different models selection approach. Those
  techniques have to be used with parsimony, but can speed up your analysis.
